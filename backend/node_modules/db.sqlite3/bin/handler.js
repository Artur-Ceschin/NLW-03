...
if(!db){
    db = new sqlite3.Database('./json.sqlite');
}
...
module.exports = {
    ...
    */
    ...
    /**
     * Using 'new' on this funtion creates a new instance of a table.
...
function arbitrate(method, params, tableName){
    ...
    db.run(`CREATE TABLE IF NOT EXISTS ${options.table} (ID TEXT, json TEXT)`);
